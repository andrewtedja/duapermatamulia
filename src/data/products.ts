...
export const products: Product[] = [
  {
    ...
    imgPath: '/images/products/tr615/f3.avif',
    slug: 'tr-615',
    overlay: 87,
    productImagePath: '/images/products/tr615/prod-tr615.avif',
    layout: {
      imageSize: 1000,
      imageAlign: 'center',
      textAlign: 'left',
...

  {
    ...
    slug: 'tr-315',
    overlay: 10,
    productImagePath: '/images/products/prod-tr315down.avif',
    layout: {
      imageSize: 800,
      imageAlign: 'center',
      textAlign: 'left',
  ...
  },
  {
    ...
    slug: 'cam-570',
    overlay: 0,
    productImagePath: '/images/products/cam570-1.avif',
    layout: {
      imageSize: 1200,
      imageAlign: 'center',
      textAlign: 'left',
...

  {
    ...
    imgPath: '/images/backgrounds/bg-hub30new.avif',
    slug: 'hub-30',
    overlay: 30,
    productImagePath: '/images/products/prod-hub30.avif',
    layout: {
      imageSize: 900,
      imageAlign: 'center',
      textAlign: 'left',
...

  {
    ...
    imgPath: '/images/backgrounds/bg-saa5.avif',
    slug: 'sa-a5',
    overlay: 0,
    productImagePath: '/images/products/prod-saa5.avif',
    layout: {
      imageSize: 900,
      imageAlign: 'center',
      textAlign: 'left',
  ...
  },
  {
    ...
    imgPath: '/images/backgrounds/bg-ptz211.avif',
    slug: 'ptz-211',
    overlay: 60,
    productImagePath: '/images/products/ptz211/prod-ptz211-2.avif',
    layout: {
      imageSize: 1000,
      imageAlign: 'center',
      textAlign: 'left',
...

  {
    ...
    slug: 'mt-100',
    overlay: 0,
    productImagePath: '/images/products/prod-mt100.avif',
    layout: {
      imageSize: 1200,
      imageAlign: 'left',
      textAlign: 'left',
  ...
  },
  {
    ...
    imgPath: '/images/backgrounds/bg-u70i.avif',
    slug: 'u70-i',
    overlay: 0,
    productImagePath: '/images/products/prod-u70i.avif',
    layout: {
      imageSize: 500,
      imageAlign: 'center',
      textAlign: 'left',
  ...
  },
  {
    ...
    imgPath: '/images/backgrounds/bg-m70w.avif',
    slug: 'm70-w',
    overlay: 0,
    productImagePath: '/images/products/prod-m70w.avif',
    layout: {
      imageSize: 1000,
      imageAlign: 'center',
      textAlign: 'left',
  ...
  },
  {
    ...
    imgPath: '/images/backgrounds/bg-tr211.avif',
    slug: 'tr-211',
    overlay: 80,
    productImagePath: '/images/products/prod-tr211.avif',
    layout: {
      imageSize: 1000,
      imageAlign: 'center',
      textAlign: 'left',
  ...
  },
  {
    ...
    slug: 'vb-370a',
    overlay: 0,
    productImagePath: '/images/products/prod-vb370a.avif',
    layout: {
      imageSize: 1000,
      imageAlign: 'center',
      textAlign: 'left',
...

  {
    ...
    description: '',
    imgPath: '/images/backgrounds/bg-vb342pro.avif',
    slug: 'vb342-pro',
    overlay: 85,
    productImagePath: '/images/products/vb342pro/vb342pro-1.avif',
    layout: {
      imageSize: 1000,
      imageAlign: 'center',
      textAlign: 'left',
  ...
  },
  {
    ...
    imgPath: '/images/backgrounds/bg-fone700.avif',
    slug: 'fone-700',
    overlay: 90,
    productImagePath: '/images/products/prod-fone700.avif',
    layout: {
      imageSize: 1000,
      imageAlign: 'center',
      textAlign: 'left',
  ...
  },
  {
    ...
    description: '',
    imgPath: '/images/backgrounds/bg-vb350.avif',
    slug: 'vb-350',
    overlay: 60,
    productImagePath: '/images/products/prod-vb350.avif',
    layout: {
      imageSize: 1000,
      imageAlign: 'center',
      textAlign: 'left',
