...
export const partners: Partner[] = [
  {
    id: 'shure',
    name: 'SHURE',
    logo: '/images/solutions/shure.avif',
    description:
    ...
    pdfThumbnail: '/images/thumbnails/tn-shure.avif',
    pdfPath: '/pdfs/pdf-shure.pdf'
  },
  {
    id: 'sennheiser',
    name: 'SENNHEISER',
    logo: '/images/solutions/sennheiser.avif',
    description:
    ...
    pdfThumbnail: '/images/thumbnails/tn-sennheiser.avif',
    pdfPath: '/pdfs/pdf-sennheiser.pdf'
  },
  {
    id: 'yamaha',
    name: 'YAMAHA',
    logo: '/images/solutions/yamaha.avif',
    description:
    ...
    pdfThumbnail: '/images/thumbnails/tn-yamaha.avif',
    pdfPath: '/pdfs/pdf-yamaha.pdf'
  },
  {
    id: 'audiotechnica',
    name: 'Audio-Technica',
    logo: '/images/solutions/audiotechnica.avif',
    description:
    ...
    pdfThumbnail: '/images/thumbnails/tn-audiotechnica.avif',
    pdfPath: '/pdfs/pdf-audiotechnica.pdf'
  },
  {
    id: 'biamp',
    name: 'Biamp',
    logo: '/images/solutions/biamp.avif',
    description:
    ...
    pdfThumbnail: '/images/thumbnails/tn-biamp.avif',
    pdfPath: '/pdfs/pdf-biamp.pdf'
  },
  {
    id: 'bosch',
    name: 'BOSCH',
    logo: '/images/solutions/bosch.avif',
    description:
    ...
    pdfThumbnail: '/images/thumbnails/tn-bosch.avif',
    pdfPath: '/pdfs/pdf-bosch.pdf'
  },
  {
    id: 'clearone',
    name: 'ClearOne',
    logo: '/images/solutions/clearone.avif',
    description:
    ...
    pdfThumbnail: '/images/thumbnails/tn-clearone.avif',
    pdfPath: '/pdfs/pdf-clearone.pdf'
  },
  {
    id: 'nureva',
    name: 'Nureva',
    logo: '/images/solutions/nureva.avif',
    description:
    ...
    pdfThumbnail: '/images/thumbnails/tn-nureva.avif',
